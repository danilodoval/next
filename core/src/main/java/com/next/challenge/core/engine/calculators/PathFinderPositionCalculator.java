...
import com.next.challenge.core.engine.calculators.PathFinderPositionCalculator.PathFinderListener.StandardPathFinderListener;
...
public final class PathFinderPositionCalculator extends AbstractPositionCalculator2D {
    ...
    public interface PathFinderListener {
        ...
        enum StandardPathFinderListener implements PathFinderListener {
            EMPTY {
                @Override
