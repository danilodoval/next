...
public class JPanelPathFinderListener extends JPanel implements PathFinderPositionCalculator.PathFinderListener {

    private static final long serialVersionUID = -2602902438192375955L;

    private PathFinderPositionCalculator.PathFinder pathFinder;
    ...
    @Override
    public void step(final PathFinderPositionCalculator.PathFinder pathFinder) {
    ...
    public static void main(final String[] args) throws InterruptedException {
        ...
        final SimulatorMap2D simulatorMap2D = new SimulatorMap2D();
        ...
        while (true) {
            ...
            try {
                final PathFinderPositionCalculator.PathFinder pathFinder = new PathFinderPositionCalculator(simulatorMap2D).new PathFinder(listener,
                        origin, destination);
                pathFinder.process();
